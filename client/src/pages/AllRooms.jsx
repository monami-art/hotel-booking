...
const AllRooms = () => {
    ...
    // Function to sort rooms on the selected sort option
    const sortRooms = (a, b) => {
    ...
    }, [rooms, selectedFilters, selectedSort, useSearchParams]);
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl-px-32'>
        ...
        <div>
            ...
            {filteredRoom.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-600 last:pb-30 last:border-0'>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 lg:mb-8 lg:mt-16'>
            ...
            <div className={`${openFilters ? 'h-auto' : "h-0 lg:h-auto"} overflow-hidden transition-all duration-700`}>
                ...
                <div className='px-5 pt-5'>
                    <p className='font-medium text-gray-800 pb-2'>PriceRange</p>
                ...
                <div className='px-5 pt-5 pb-7'>
                    <p className='font-medium text-gray-800 pb-2 p'>Sort By</p>

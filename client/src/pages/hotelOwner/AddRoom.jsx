...
const AddRoom = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Title align='left' font='outfit' title='Add Room' subTitle='Please provide accurate and detailed information regarding room features, pricing, and amenities to optimize the user booking experience' />
